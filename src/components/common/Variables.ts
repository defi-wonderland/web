...
export const RING_A_INDEX = 5;
export const RING_B_INDEX = 7;
export const CONTENT_INDEX = 10;
export const NAVBAR_INDEX = 1000;

export const BALL_DIAMETER = "9rem";

export const PAGE_MAX_WIDTH = "120rem";
export const NAVBAR_HEIGHT = "10.5rem";
export const PAGE_PADDING = "9rem";
